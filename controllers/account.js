...
router.post("/signup", (req, res) => {
  ...
  if (password === "") {
    ...
    passError =
      "Password must only contain letters and numbers, and must be between 6-12 characters.";
  }
    ...
    loginAuth
      ...
      .then(() => {
        ...
        const msg = {
          ...
          html: `Welcome to the Nook's Cooks family ${fName} ${lName}!<br><br>
        ...
        sgMail
          ...
          .then(() => {
            res.render("account/login", {
              signedUp:
                '<div class="alert alert-success" role="alert">Thanks for signing up! Please log in to continue!</div>',
            });
          })
          .catch((err) => {
